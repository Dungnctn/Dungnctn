        ...
        return /*html*/ `
            ...
            <div class="flex items-center justify-between h-16">
                ...
                <div class="ml-4 flex items-center md:ml-6">
                    ...
                    <div class="abc hidden origin-top-right absolute right-0 w-48 rounded-md shadow-lg py-1 bg-white ring-1 ring-black ring-opacity-5 focus:outline-none" role="menu" aria-orientation="vertical" aria-labelledby="user-menu-button" tabindex="-1">
                        <!-- Active: "bg-gray-100", Not Active: "" -->
                        <a href="#" class="block px-4 py-2 text-sm text-gray-700" role="menuitem" tabindex="-1" id="user-menu-item-0">Sửa hồ sơ</a>
            ...
            <div class="pt-4 pb-3 border-t border-gray-700">
                ...
                <a href="#" class="block px-3 py-2 rounded-md text-base font-medium text-gray-400 hover:text-white hover:bg-gray-700">Sửa hồ sơ</a>
